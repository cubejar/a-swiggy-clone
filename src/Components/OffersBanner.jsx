...
function OffersBanner() {
    return (
        <div className=' d-flex justify-content-center align-items-center mt-5 flex-column'>
            <div className='w-75 '>
                <h4 className='fw-bolder'>Best offers for all of you (X-mas special event)!!</h4>
            ...
            <div className='w-75 mt-5'>
                ...
                <h4 className='fw-bolder'>Thanks! Future Dev - What's on your mind Today and Tomorrow?</h4>
