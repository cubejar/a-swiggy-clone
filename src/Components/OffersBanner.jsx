...
function OffersBanner() {
    return (
        <div className=' d-flex justify-content-center align-items-center mt-5 flex-column'>
            <div className='w-75 '>
                <h4 className='fw-bolder'>The best offers for you from Cubejar!</h4>
            ...
            <div className='w-75 mt-5'>
                ...
                <div className='d-flex align-items-center' style={{overflowY:"scroll",gap:"19px"}}>
                    ...
                    <img className='img-fluid' width={'140px'} src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/v1675667625/PC_Creative%20refresh/Biryani_2.png" alt="VegBiriyani" />
